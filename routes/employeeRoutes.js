...
const { getEmployeeProfile, getEmployeeAppliedUsers, getEmployeeDashboard, getEmployeeServiceUsers, getAppliedByMe, getDashboard } = require("../controllers/employeeController");
...
router.get("/dash", auth,authorizeRole("EMPLOYEE"),getDashboard );
