...
const { applyLeave, checkIn, checkOut, getAttendanceHistory, getWorkDayStatus,getAttendanceSummary } =require( '../controllers/attendanceController');
...
router.get("/summary", auth,authorizeRole("EMPLOYEE"), getAttendanceSummary);
